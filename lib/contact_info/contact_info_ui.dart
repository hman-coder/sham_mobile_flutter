...
import 'package:sham_mobile/contact_info/contact_info_controller.dart';
            ...
            child: Center(
              child: Obx(() =>
                  CheckboxListTile(
                    ...
                    title: Text("phone_number".tr, style: TextStyle(fontSize: DefaultValues.mediumTextSize),),
          ...
          Expanded(
            child: Center(
              child: Obx(() => CheckboxListTile(
                  ...
                  title: Text("personal_info".tr, style: TextStyle(fontSize: DefaultValues.mediumTextSize)),
            ...
            child: Center(
              child: Obx(() => CheckboxListTile(
                  secondary: Icon(Icons.location_on),
                    title: Text("address".tr, style: TextStyle(fontSize: DefaultValues.mediumTextSize)),
